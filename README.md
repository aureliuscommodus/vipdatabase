...
<p><b><pre><code>Measure of information gain explanation :</code></pre></b>: You have  cardinality of entities  defined  as in the following  suggestive example :<pre><code>cardinality(entity) := count(elem  foreach elem in entity)</code></pre></p>
